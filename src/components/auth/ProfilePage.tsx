  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white border border-gray-200 dark:bg-dark-800 dark:border-dark-700 rounded-xl p-6 mb-8">
          <div className="flex flex-col md:flex-row items-start gap-6">
            <div className="w-24 h-24 rounded-full overflow-hidden bg-gray-200 dark:bg-dark-700 flex-shrink-0">
              {user.imageUrl && (
                <img 
                  src={user.imageUrl} 
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-4">{user.primaryEmailAddress?.emailAddress}</p>
              
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-primary-500/20 text-primary-400 rounded-full text-sm">
                  Car Enthusiast
                </span>
                <span className="px-3 py-1 bg-gray-200 text-gray-700 dark:bg-dark-700 dark:text-gray-300 rounded-full text-sm">
                  Free Plan
                </span>
              </div>
            </div>
        ...
        <div className="bg-white border border-gray-200 dark:bg-dark-800 dark:border-dark-700 rounded-xl p-6 mb-8">
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-4">Add your first car to start showcasing your builds</p>
        ...
        <div className="bg-white border border-gray-200 dark:bg-dark-800 dark:border-dark-700 rounded-xl p-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center py-3 border-b border-dark-700">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Your public profile link</p>
              </div>
            ...
            <div className="flex justify-between items-center py-3 border-b border-dark-700">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Current plan: Free</p>
              </div>
            ...
            <div className="flex justify-between items-center py-3">
              ...
              <button className="px-3 py-1 bg-gray-200 hover:bg-gray-300 text-gray-800 dark:bg-dark-700 dark:hover:bg-dark-600 dark:text-white text-sm rounded-lg transition">
                Manage
              </button>
            </div>
          </div>
